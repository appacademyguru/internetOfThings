...
// What page to grab!
  ...
  #define WEBSITE      "meganiot2.meteor.com" //domain the Arduino will access
...
////Wifi Network credentials
//#define WLAN_SSID       "Arduino24"           // Network name, cannot be longer than 32 characters!
//#define WLAN_PASS       "ItsASecret"        // Network password
//// Security can be WLAN_SEC_UNSEC, WLAN_SEC_WEP, WLAN_SEC_WPA or WLAN_SEC_WPA2
//#define WLAN_SECURITY   WLAN_SEC_WPA2
//
//// What page to grab!
...
//            String randString = String(randomNum);
