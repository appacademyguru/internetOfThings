...
pefarduino2.meteor.com is the unmodified version of the Meteor project. You can use it to test your code.  The buttons change the data value to 5 and 10, and you can input your own data value in the form.
