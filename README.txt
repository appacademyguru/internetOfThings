...
*Hints*
The CC3000 wifi module uses several digital pins to communicate with the Arduino (precisely which pins are listed in the Arduino sketches), so it might behoove you to block these pins so you don't forget and accidentally use them for something else.
